...
const LabSurge = lazy(() => import('./components/LabSurge'));
...
const InnerApp = () => {
  // DogeOS is the authoritative wallet source — see useEffectiveAccount for
  // why (wagmi's own useAccount() under-reports on desktop since injected
  // discovery was disabled there to fix the createEmitter crash).
        ...
        {!showWelcome && !isLoading && !isCheckingRegistration && !showTelegramAuth && (
          <Router>
            ...
            <Routes>
              ...
              <Route path="/lab-surge" element={<LabSurge playerAddress={effectiveAddress || 'GUEST_USER'} />} />
