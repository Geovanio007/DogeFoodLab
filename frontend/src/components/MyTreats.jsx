        ...
        <div className="relative p-4">
          ...
          <div className="flex justify-between items-start mb-3">
            ...
            <Badge
              ...
              style={{
                background: getSeasonLabel(treat) === 'S2' ? 'rgba(45,212,191,0.15)' : 'rgba(255,255,255,0.08)',
                color: getSeasonLabel(treat) === 'S2' ? '#2dd4bf' : 'rgba(255,255,255,0.6)',
                border: getSeasonLabel(treat) === 'S2' ? '1px solid rgba(45,212,191,0.35)' : '1px solid rgba(255,255,255,0.12)',
              }}
            >
              {getSeasonLabel(treat)}
            </Badge>
          </div>
