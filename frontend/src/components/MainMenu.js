...
/* ─── Booster Package CTA Bubble ─────────────────────────────────────────────
   ...
   Auto-Mixer + 10 extra lives + 5,000 points). Same fixed-widget language
   as SpinWheelCTA (dismiss button, bounce animation, drop-shadow bubble),
   mirrored on the left instead of the bottom-right so the two don't compete
   for the same corner. Vertical centering needs its own non-animated
   wrapper since the bounce keyframes already own `transform` on the inner
   element.
   ─────────────────────────────────────────────────────────────────────────── */
...
const BoosterPackageCTA = ({ playerAddress }) => {
  ...
  return (
    <>
      <div style={{ position: 'fixed', left: 14, top: '50%', transform: 'translateY(-50%)', zIndex: 998 }}>
        <div
          style={{
            display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6,
            filter: 'drop-shadow(0 4px 16px rgba(245,158,11,0.45))',
            animation: 'boosterBounce 2.5s ease-in-out infinite',
          }}
        >
          <style>{`
          ...
          <button
            ...
            style={{
              position: 'relative',
              background: 'linear-gradient(160deg, #fde68a 0%, #f59e0b 55%, #b45309 100%)',
          ...
          >
            <div
              style={{
                ...
                background: 'rgba(11,23,56,0.15)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}
            >
              <Gift className="w-6 h-6" style={{ color: '#3a1d02' }} />
            </div>
            <span style={{
              fontSize: 9, fontWeight: 800, color: '#3a1d02',
            ...
            <span style={{
              fontSize: 9, fontWeight: 700, color: '#5c2e00',
              lineHeight: 1, whiteSpace: 'nowrap', opacity: 0.85,
            }}>
      ...
      >
        ...
        >
          <button
            ...
            style={{ background: 'rgba(11,23,56,0.25)' }}
            aria-label="Close"
          >
            <X className="w-4 h-4" style={{ color: '#3a1d02' }} />
          </button>
          <div
            className="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-2"
            style={{ background: 'rgba(11,23,56,0.15)' }}
          >
            <Gift className="w-8 h-8" style={{ color: '#3a1d02' }} />
          </div>
          <h3 className="text-lg font-bold" style={{ color: '#3a1d02' }}>Booster Pack</h3>
          <p className="text-xs mt-0.5" style={{ color: '#5c2e00' }}>Everything you need to get ahead, all at once</p>
        </div>
